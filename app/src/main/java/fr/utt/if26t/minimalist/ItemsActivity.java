    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new ItemAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                getModifyItem(position);
            }
        });
    }

    public void getModifyItem(long id) {
        Intent myIntent = new Intent(getBaseContext(), ModifyItem.class);
        myIntent.putExtra("KEY_LIST", (int) id);
        myIntent.putExtra("CURRENT_LIST_ID", (int) intListId);
